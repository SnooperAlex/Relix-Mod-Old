package com.snooper.relix.items;
...
public class EarthHammer extends MiningToolItem {
    private static final Set<Block> EFFECTIVE_BLOCKS;

    public EarthHammer(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
